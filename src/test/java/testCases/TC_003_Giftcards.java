...
public class TC_003_Giftcards extends BaseClass
{
	...
	@Test(priority=6,groups= {"master"},dataProvider="dp",dataProviderClass=DataProviders.class)
	...
	@Test(priority=7,groups= {"master"},dataProvider ="dp",dataProviderClass=DataProviders.class)
	...
	@Test(priority=8,groups= {"master"},dataProvider ="dp",dataProviderClass=DataProviders.class)
